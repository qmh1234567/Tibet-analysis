...
# 需要修改路径
tf.flags.DEFINE_string("checkpoint_dir", "./../cnn_classfication/runs/1540391854/checkpoints/", "Checkpoint directory from training run")
# 需要修改为TRUE
...
print("\nlen(allpredictions)",len(all_predictions))
print("\nnp.array(x_raw)",np.array(x_raw).shape[0])
